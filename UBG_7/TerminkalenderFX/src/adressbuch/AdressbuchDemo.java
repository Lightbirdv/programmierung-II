...
public class AdressbuchDemo
{
     ...
     */
    public AdressbuchDemo() throws DoppelterSchluesselException, UngueltigerSchluesselException
    {
        buch = new Adressbuch();
     ...
     */
    public void zeigeSchnittstelle() throws UngueltigerSchluesselException, KeinPassenderKontaktException
    {
        interaktion.starten();
    }
    ...
    public static void main(String[] args) throws UngueltigerSchluesselException, KeinPassenderKontaktException {
